...
1) [Рабочее окружение](https://github.com/NatashaTronina/AHJ-86-homework/tree/main/1.%20Рабочее%20окружение)
2) [DOM]()
3) [Обработка событий]()
...
3) [Работа с HTTP]()
## Интерактивность
1) [REST, Server-sent events, WebSockets]()
2) [Анимации и CSS]()
3)  [Geolocation, Notification, Media]()
## Advanced
1)  [RxJS]()
